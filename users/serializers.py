...
class UserSerializer(serializers.ModelSerializer):
    ...
    profile_id = serializers.URLField(source='profile.id', allow_blank=True, read_only=True)

    class Meta:
        model = User
        fields = ('id', 'username', 'password', 'email','is_staff','confirm_pass','profile_id', 'new_pass', 'new_confirm_pass')
...
class ProfileSerializer(serializers.HyperlinkedModelSerializer):
    ...
    class Meta:
        model = Profile
        fields = ('id','url','user','profileimage')
